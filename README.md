...
| `wwtdigital-design` | The WWT deck design system (a Presentation add-on; brings the Figma MCP and a one-time setup) | `/plugin install wwtdigital-design@wwtdigital` |
