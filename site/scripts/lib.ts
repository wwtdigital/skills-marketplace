...
// One bundle plugin per category, plus standalone plugins that declare a category in their
// marketplace entry. A skill's metadata.category must match the category of the plugin it's in.
